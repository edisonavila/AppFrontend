					...
					<div class="card-body">
						...
						<div class="form-group d-flex">
							<div class="col-sm-6 d-flex">
								<input type="number" name="cedulacliente" class="form-control" placeholder="Cedula" value="">
								<input type="submit" name="accion" value="BuscarCliente" class="btn btn-outline-info">
							</div>
						</div>
						<div class="col-sm-6">
							<input type="text" name="NombreCliente" class="form-control" placeholder="Nombre Cliente" value="" disabled="disabled">						
						</div>
					</div>
				</div>
				<div class="card">
					...
					<div class="form-group d-flex">
						<div class="col-sm-6 d-flex">
							<input type="number" name="codigoproducto" class="form-control" placeholder="Codigo" value="">
							<input type="submit" name="accion" value="BuscarProducto" class="btn btn-outline-info">
						</div>
						<div class="col-sm-6 d-flex">
							<input type="text" name="nombreproducto" class="form-control" placeholder="Nombre Producto" value="">
						</div>
					</div>
					<div class="form-group d-flex">
						<div class="col-sm-6 d-flex">
